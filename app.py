...
df_1=pd.read_csv(r"C:\Users\218883\.spyder-py3\Churn analysis\first_telc.csv")

q = ""

@app.route("/")
def loadPage():
	return render_template(r"home.html", query="")
...
def predict():
    ...
    model = pickle.load(open(r"C:\Users\218883\.spyder-py3\Churn analysis\model.sav", "rb"))
